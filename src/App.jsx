...
import { AiFillDelete, AiFillNotification } from "react-icons/ai";
       ...
       <div className="mx-3 md:container md:mx-auto my-5 rounded-xl p-5 bg-violet-100 min-h-[80vh] md:w-[35%]">
        <h1 className='font-bold text-center text-2xl'>TaskMaster - Manage your todos at one place</h1>
         <div className="addTodo my-5 flex flex-col gap-4">
          ...
          <button onClick={handleAdd} disabled={todo.length<=3} className='bg-blue-950 mx-2 rounded-full hover:bg-blue-900 disabled:bg-blue-500 p-4 py-2 text-sm font-bold text-white'>Save</button>
          </div>
         </div>
